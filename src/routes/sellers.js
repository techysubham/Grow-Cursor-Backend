...
router.get('/all', requireAuth, requireRole('fulfillmentadmin', 'superadmin', 'compatibilityadmin', 'compatibilityeditor', 'listingadmin', 'hoc', 'compliancemanager'), async (req, res) => {
